...
using Herald.OSS.Serilog.Settings; // ReadFrom.Configuration
...
Log.Logger = new LoggerConfiguration()
    ...
    .CreateLogger(); // Herald: CreateBootstrapLogger not in surface; CreateLogger is the equivalent
...
Log.CloseAndFlush(); // Herald: sync CloseAndFlush (no async variant in surface)
return 0;
